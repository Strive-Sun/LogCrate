...
const ENTRY_TABLE: Record<string, EntryMeta> = {
  'crash-0715.zip::app.log': {
    ...
    lineCount: 5_000_000,
    compressed: true,
    entry: { path: 'app.log', size: 340 * 1024 * 1024, isLog: true, encrypted: false, isArchive: false },
  },
  'crash-0715.zip::sys.log': {
    seed: 2,
    lineCount: 120_000,
    compressed: true,
    entry: { path: 'sys.log', size: 12 * 1024 * 1024, isLog: true, encrypted: false, isArchive: false },
  },
  'crash-0715.zip::boot.txt': {
    seed: 3,
    lineCount: 8_400,
    compressed: true,
    entry: { path: 'boot.txt', size: 1.2 * 1024 * 1024, isLog: true, encrypted: false, isArchive: false },
  },
  'crash-0715.zip::core.bin': {
    seed: 4,
    lineCount: 0,
    compressed: true,
    entry: { path: 'core.bin', size: 88 * 1024 * 1024, isLog: false, encrypted: false, isArchive: false },
  },
  'server.log': {
    seed: 7,
    lineCount: 42_000,
    compressed: false,
    entry: { path: 'server.log', size: 6 * 1024 * 1024, isLog: true, encrypted: false, isArchive: false },
  },
  'device3.zip::device.log': {
    seed: 9,
    lineCount: 260_000,
    compressed: true,
    entry: { path: 'device.log', size: 20 * 1024 * 1024, isLog: true, encrypted: false, isArchive: false },
  },
};
